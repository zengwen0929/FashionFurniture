...
@interface ZWStyleDescViewController ()<UICollectionViewDataSource, CHTCollectionViewDelegateWaterfallLayout,MJRefreshBaseViewDelegate>
...
@implementation ZWStyleDescViewController
...
- (void)getDatas{
    ...
    NSDictionary *parameters=@{@"moneyType":@"0",Kpage:@(_page),@"productStyleId":self.productStyleId,@"orderby":@"newproduct"};
    self.url=@"http://116.204.13.36:7777/api/goods/productStyleList";
    // NSLog(@"%@",self.typeId);
    // NSLog(@"%@",self.url);
    // 3.发送请求
