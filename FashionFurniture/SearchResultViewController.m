...
@interface SearchResultViewController ()<UICollectionViewDataSource, CHTCollectionViewDelegateWaterfallLayout,MJRefreshBaseViewDelegate>
...
- (void)getDatas{
    ...
    NSDictionary *parameters=@{@"moneyType":@"0",Kpage:@(_page),@"searchKey":self.searchResult,};
   NSString *url = @"http://116.204.13.36:7777/api/goods/searchList";
